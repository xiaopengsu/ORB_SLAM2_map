...
public:
    ...
    //cv::Mat &t
    void SaveReLocalFrameTrajectoryTUM(const string &filename,const double &timestamp,const cv::Mat Tcw, float scale);
    void SaveEveryFrameTrajectoryTUMCount(const string &filename,const int &count,const double &timestamp,const cv::Mat Tcw, float scale);
